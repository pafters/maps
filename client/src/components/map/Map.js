...
export default function Map({ currentPlace, activePlace }) {
      return (
            <div className="rf-map">
                  {<div id="district-cont" className={`district ${(currentPlace !== '' || activePlace !== '') ? '' : 'hidden'}`}>
                        <b className={`${(currentPlace !== '' && currentPlace !== activePlace) ? 'current' : ''}${(currentPlace !== '' || activePlace !== '') ? '' : 'hidden'}`} />
                        <span>{currentPlace ? currentPlace : activePlace}</span>
                  </div>}
